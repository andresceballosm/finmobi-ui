        ...
        <div className="container">
          ...
          <div className="client-review-img">
            <img
              ...
              src={publicUrl + "/assets/img/client/5.png"}
              alt="client"
            />
            <img
              className="clr-img clr-img2"
              src={publicUrl + "/assets/img/client/6.png"}
              alt="client"
            />
            <img
              className="clr-img clr-img3"
              src={publicUrl + "/assets/img/client/7.png"}
              alt="client"
            />
            <img
              className="clr-img clr-img4"
              src={publicUrl + "/assets/img/client/8.png"}
              alt="client"
            />
            <img
              className="clr-img clr-img5"
              src={publicUrl + "/assets/img/client/9.png"}
              alt="client"
            />
