                ...
                <div className="row">
                  <div className="col-lg-6">
                    <div className="single-leading-feature">
                      ...
                      <div className="thumb">
                        <img
                          src={publicUrl + item.imageFirstItem}
                          alt={imagealt}
                        />
                      </div>
                  ...
                  <div className="col-lg-3 col-sm-6">
                    <div className="single-feature">
                      <div className="thumb">
                        <img
                          src={publicUrl + item.imageThirdItem}
                          alt={imagealt}
                        />
                      </div>
                      <div className="details">
                        <a href="#" className="feature-logo">
                          <img
                            src={publicUrl + item.iconSecondItem}
                            alt={imagealt}
                          />
                        </a>
                        <p className="author">
                          <i className="fa fa-user" />{" "}
                          {item.authornameSecondItem}
                        </p>
                        <h6 className="title readeal-top">
                          <Link to="/property-details">
                            {item.titleSecondItem}
                          </Link>
                        </h6>
                        <h6 className="price">{item.newerpriceSecondItem}</h6>
                        <del>{item.olderpriceSecondItem}</del>
                  ...
                  <div className="col-lg-3 col-sm-6">
                    <div className="single-feature">
                      ...
                      <div className="details">
                        <a href="#" className="feature-logo">
                          <img
                            src={publicUrl + item.iconThirdItem}
                            alt={imagealt}
                          />
                        </a>
                        <p className="author">
                          <i className="fa fa-user" />{" "}
                          {item.authornameThirdItem}
                        </p>
                        <h6 className="title readeal-top">
                          <Link to="/property-details">
                            {item.titleThirdItem}
                        ...
                        <h6 className="price">{item.newerpriceThirdItem}</h6>
                        <del>{item.olderpriceThirdItem}</del>
                        <ul className="info-list">
